      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return preview
                ? setPreview()
                : setCamera(location.list, other, position, result[1]);
          } else {
...
// class _SignOutPageStatex extends State<SignOutPage> {
//   late CameraController _controller;
//   late Future<void> _initializeControllerFuture;

//   Uri gMapsApiUrl = Uri.parse(
...
//   Map<String, num> goHomeCoordinate = {'lat': 0, 'lon': 0};
...
//                                               queryParameters: {
//                                                 'center':
//                                                     "${goHomeCoordinate['lat']},${goHomeCoordinate['lon']}",
//                                                 'size': '100x200',
//                                                 'zoom': '18',
//                                                 'key': "${Env.gMapKey}",
//                                               },
...
//                                 child: ElevatedButton.icon(
//                                   onPressed: () =>
//                                       captureAndUpload(detail.pegawai_id),
//                                   icon: const Icon(
//                                     Icons.login,
//                                     size: 18,
//                                     color: Colors.white,
