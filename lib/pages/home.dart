...
class _MyHomePageState extends ConsumerState<MyHomePage> {
  ...
  Future<bool?> checkException(DateTime time, String reason) async {
    try {
      ...
      final url = Uri.parse(
        "${Env.api}/api/mobile/hasException/$pegawaiId/$reason",
      );
  ...
  Future<DateTime?> getTime() async {
    try {
      final response = await http
          .get(Uri.parse("${Env.api}/api/mobile/timenow"))
                            ...
                            onPressed: () async {
                              ...
                              if (!status.signedIn && time != null) {
                                if (time.isBefore(
                                  ...
                                  bool? exception = await checkException(
                                    time,
                                    "Cuti setengah hari",
                                  );
